        ...
        for hand_landmarks in result.multi_hand_landmarks:
            ...
            if hand_landmarks.landmark[8].y > hand_landmarks.landmark[7].y > hand_landmarks.landmark[6].y > \
                ...
                cv2.putText(
                    ...
                    abs(hand_landmarks.landmark[4].x - hand_landmarks.landmark[17].x) > abs(hand_landmarks.landmark[4].x - hand_landmarks.landmark[5].x): # afstand duim en pink vergelijken
                cv2.putText(
                    img=img,
                    text=str("Five"),
                    org=(0, 20),
